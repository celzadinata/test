    ...
    <div className="bg-white text-black min-h-screen">
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
          ...
          <div className="lg:col-span-3 border-t border-b border-gray-200">
                  ...
                  {randomNews.data.file_news.map(
                    (file: FileType, index: number) =>
                      file.description === "HEADLINE" && (
                        <div
                          key={index}
                          className="relative rounded-md overflow-hidden bg-cover bg-no-repeat md:w-120"
                        >
                          <Image
                            src={file.url}
                            alt="News Headline"
                            width={500}
                            height={300}
                            className="w-full rounded-md h-auto transition duration-300 ease-in-out hover:scale-110"
                          />
                        </div>
                      )
                  )}
          ...
          {/* Sidebar - 1 column */}
          <div className="lg:col-span-1 border-t border-b border-gray-200">
